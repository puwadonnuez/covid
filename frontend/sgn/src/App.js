...
import InfectionBarChart from "./infection-charts";
...
function App() {
  const color = [
    ...
    "#f205e6" ,"#1c0365" ,"#14a9ad" ,"#41d158" ,"#b2b4f0" ,"#d298e2" ,"#6119d0",
    ...
    "#dba2e6", "#76fc1b", "#608fa4", "#20f6ba", "#07d7f6", "#dce77a", "#14a9ad"]
  const [count, setCount] = useState(0);
  const [infectionReport, setReport] = useState([]);
  const [infectionDate, setInfectionDate] = useState([]);
  const [infectionPerDay, setInfectionPerDay] = useState([]);
  const dateOfInfection = [];
  let i=0;
  let report = [];
  useEffect(async () => {
